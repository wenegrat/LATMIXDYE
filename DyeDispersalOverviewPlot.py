...
filename = '/home/jacob/dedalus/LATMIX/front.mat' # Front run
...
subplotdict['dye1f'] = plt.subplot2grid((3,34), (0,4), colspan=12)
subplotdict['prf2f'] = plt.subplot2grid((3,34), (1,0), colspan=4)
subplotdict['dye2f'] = plt.subplot2grid((3,34), (1,4), colspan=12)
subplotdict['prf3f'] = plt.subplot2grid((3,34), (2,0), colspan=4)
subplotdict['dye3f'] = plt.subplot2grid((3,34), (2,4), colspan=12)
#### Timesteps ########
...
subplotdict['prf1nf'] = plt.subplot2grid((3,34), (0,18), colspan=4)
subplotdict['dye1nf'] = plt.subplot2grid((3,34), (0,22), colspan=12)
subplotdict['prf2nf'] = plt.subplot2grid((3,34), (1,18), colspan=4)
subplotdict['dye2nf'] = plt.subplot2grid((3,34), (1,22), colspan=12)
subplotdict['prf3nf'] = plt.subplot2grid((3,34), (2,18), colspan=4)
subplotdict['dye3nf'] = plt.subplot2grid((3,34), (2,22), colspan=12)
#### Timesteps ########
...
for i in range(1, 4):
    ...
    # MAKE PLOTS
    rotate = np.argmax(integrate.trapz(dye1_ntw[ind,1:,:], x=z[1:], axis=0)) -int(nx/2)
    rotate  = np.argmin(np.abs(x/1e3 - rotations[i]))
